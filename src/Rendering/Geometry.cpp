...
Crimson::Geometry::Geometry(std::vector<Vertex> vertices, std::vector<unsigned int> indices, bool initBuffers) {
    this->indexed = true;
    this->indices = indices;
    this->InitGeometry(vertices, initBuffers);
}

Crimson::Geometry::Geometry(std::vector<Vertex> vertices, unsigned int *indices, bool initBuffers) {
...
Crimson::Geometry::Geometry(std::vector<Vertex> vertices, bool initBuffers) {
    this->indexed = false;
    this->InitGeometry(vertices, initBuffers);
}

void Crimson::Geometry::SetIndices(unsigned int *indices, int indicesSize) {
    this->indexed = true;
    this->indices.clear();
...
void Crimson::Geometry::InitBuffers() {
...
void Crimson::Geometry::Draw(Crimson::Shader *shader) {
    shader->use();
//    if(this->hasBones)
//    {
...
void Crimson::Geometry::InitGeometry(std::vector<Vertex> verticesa, bool initBuffers) {
